...
const TEXT_TARGET_OPTIONS: MenuOption[] = [
  ...
  {
    type: "syllableChunker",
    label: "Syllable Chunker",
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
// Video target options (nodes that can accept video input)
const VIDEO_TARGET_OPTIONS: MenuOption[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125m-9.75 0V5.625m0 12.75v-1.5c0-.621.504-1.125 1.125-1.125m18.375 2.625V5.625m0 12.75c0 .621-.504 1.125-1.125 1.125m1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125m0 3.75h-7.5A1.125 1.125 0 0112 18.375m9.75-12.75c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125m19.5 0v1.5c0 .621-.504 1.125-1.125 1.125M2.25 5.625v1.5c0 .621.504 1.125 1.125 1.125m0 0h17.25m-17.25 0h7.5c.621 0 1.125.504 1.125 1.125M3.375 8.25c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125m17.25-3.75h-7.5A1.125 1.125 0 0012 9.375m9.75-1.125c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h7.5m-7.5 0c-.621 0-1.125.504-1.125 1.125M12 10.875v-1.5m0 1.5c0 .621-.504 1.125-1.125 1.125M12 10.875c0 .621.504 1.125 1.125 1.125m-2.25 0c.621 0 1.125.504 1.125 1.125M10.875 12h2.25m-2.25 0c-.621 0-1.125.504-1.125 1.125M12 12v1.5m0-1.5c0-.621.504-1.125 1.125-1.125m1.125 2.625c0-.621.504-1.125 1.125-1.125m-3.75 0c-.621 0-1.125.504-1.125 1.125m0 0v1.5c0 .621.504 1.125 1.125 1.125m-1.125-2.625c0 .621.504 1.125 1.125 1.125m0 0h3.75m-3.75 0c-.621 0-1.125.504-1.125 1.125m4.875-1.125c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m1.125-2.625c0 .621-.504 1.125-1.125 1.125" />
      </svg>
    ),
  },
  {
...
// Video source options (nodes that can output video)
...
export function ConnectionDropMenu({
  ...
  const getOptions = useCallback((): MenuOption[] => {
    ...
    if (connectionType === "source") {
      ...
      if (handleType === "image") return IMAGE_TARGET_OPTIONS;
      if (handleType === "text" || handleType === "context") return TEXT_TARGET_OPTIONS;
      if (handleType === "video") return VIDEO_TARGET_OPTIONS;
      return []; // audio - no options yet
    } else {
      // Dragging from a target handle (input), need nodes with source handles (outputs)
      if (handleType === "image") return IMAGE_SOURCE_OPTIONS;
      if (handleType === "text" || handleType === "context") return TEXT_SOURCE_OPTIONS;
